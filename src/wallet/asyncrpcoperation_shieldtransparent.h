...
#ifndef ZCASH_WALLET_ASYNCRPCOPERATION_SHIELDTRANSPARENT_H
#define ZCASH_WALLET_ASYNCRPCOPERATION_SHIELDTRANSPARENT_H
...
class AsyncRPCOperation_shieldtransparent : public AsyncRPCOperation {
public:
    AsyncRPCOperation_shieldtransparent(
    ...
    virtual ~AsyncRPCOperation_shieldtransparent();

    // We don't want to be copied or moved around
    AsyncRPCOperation_shieldtransparent(AsyncRPCOperation_shieldtransparent const&) = delete;             // Copy construct
    AsyncRPCOperation_shieldtransparent(AsyncRPCOperation_shieldtransparent&&) = delete;                  // Move construct
    AsyncRPCOperation_shieldtransparent& operator=(AsyncRPCOperation_shieldtransparent const&) = delete;  // Copy assign
    AsyncRPCOperation_shieldtransparent& operator=(AsyncRPCOperation_shieldtransparent &&) = delete;      // Move assign
...
private:
    friend class TEST_FRIEND_AsyncRPCOperation_shieldtransparent;    // class for unit testing
...
class TEST_FRIEND_AsyncRPCOperation_shieldtransparent {
public:
    std::shared_ptr<AsyncRPCOperation_shieldtransparent> delegate;

    TEST_FRIEND_AsyncRPCOperation_shieldtransparent(std::shared_ptr<AsyncRPCOperation_shieldtransparent> ptr) : delegate(ptr) {}
...
#endif // ZCASH_WALLET_ASYNCRPCOPERATION_SHIELDTRANSPARENT_H
